...
interface GalleryBlogsProps {
  initialBlogs: GalleryBlog[]
  initialPage: number
...
export default function GalleryBlogs({
  ...
  const [galleryBlogs, setGalleryBlogs] = useState<GalleryBlog[]>(initialBlogs)
          ...
          <div 
            ...
            onClick={() => {
              if (blog.externalUrl) {
                ...
                router.push(`/gallery-blog/${blog.slug}`)
              }
            }}
          >
