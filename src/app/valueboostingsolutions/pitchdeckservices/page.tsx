...
export default function PitchDeckServices() {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-10">
              <span style={{ color: '#A5292A' }}>Pitch Deck Services</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center px-4 sm:px-8 md:px-12 lg:px-20">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 mb-6">
                Turn Your <span style={{ color: '#A5292A' }}>Vision</span> Into an Investor-Ready Pitch
              </h2>
      ...
      <section className="py-20" style={{ backgroundColor: "#FAFAFA" }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              Our Comprehensive <span style={{ color: '#A5292A' }}>Pitch Deck Services</span>
            </h2>
                  ...
                  >
                    ...
                    <div className="mt-auto">
                      <a
                        ...
                        className="text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-all w-full inline-block text-center"
                        style={{ backgroundColor: "#A5292A" }}
                      >
                        Book Now
                      </a>
